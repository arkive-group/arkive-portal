    ...
    <div style={main}>
      <Container style={container}>
        ...
        <Text style={paragraph}>
          Welcome to our circular beauty family! You now belong to our community
          of impact pioneers who care about their looks and our planet.
        ...
        <Text style={paragraph}>
          Would you like to support us? Follow our growth journey through our{" "}
          <Link href="https://www.instagram.com/arkiveshop/">Instagram</Link> or
          on{" "}
          <Link href="https://www.linkedin.com/company/shoparkive/?viewAsMember=true">
            LinkedIn
          </Link>
          . Want to help us accelerate our journey? Donate 50,- to accelerate
          circularity in the beauty industry where we will invest the budget in
          PR + marketing [
          <Link href="https://www.ing.nl/de-ing/payreq?trxid=5ZELTTcabJMfxy4qtgVAoXntpsEiRbPL&flow-step=payment-request">
            donate here
          </Link>
          ].
        </Text>
